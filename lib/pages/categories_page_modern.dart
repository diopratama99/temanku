...
class CategoriesPageModern extends StatefulWidget {
  const CategoriesPageModern({super.key});

  @override
  State<CategoriesPageModern> createState() => _CategoriesPageModernState();
}

class _CategoriesPageModernState extends State<CategoriesPageModern> {
