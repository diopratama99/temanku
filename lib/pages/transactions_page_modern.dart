...
class TransactionsPageModern extends StatefulWidget {
  final bool hideAddButton;

  const TransactionsPageModern({super.key, this.hideAddButton = false});

  @override
  State<TransactionsPageModern> createState() => _TransactionsPageModernState();
}

class _TransactionsPageModernState extends State<TransactionsPageModern> {
  ...
  Future<void> _navigateToAdd() async {
    await Navigator.push(
      ...
      MaterialPageRoute(
        builder: (_) =>
            const AddTransactionSimplePage(showHistoryButton: false),
      ),
    );
    await _load();
  }
